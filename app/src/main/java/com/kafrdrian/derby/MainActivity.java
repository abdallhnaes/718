...
public class MainActivity extends Activity {
    ...
    private void showManagerGate() {
        ...
        root.addView(text("اختر نوع المدير ثم أدخل الرمز", 15, Color.LTGRAY, Typeface.BOLD));
        ...
        root.addView(text("المدير الرئيسي ينظم كل شيء. مدير الفريق الثاني يعدل فريقه فقط ويملك خيار إخفاء تشكيلته.", 14, Color.LTGRAY, Typeface.BOLD));
    }
    ...
    private void showPinLogin(int requestedRole) {
        ...
        root.addView(text("أدخل رمز الدخول", 15, Color.LTGRAY, Typeface.BOLD));
        ...
        String hint = requestedRole == 1 ? "رمز المدير الرئيسي الافتراضي: 5135" : "رمز مدير الفريق الثاني الافتراضي: 2222";
        root.addView(text(hint, 13, Color.LTGRAY, Typeface.BOLD));
    }
